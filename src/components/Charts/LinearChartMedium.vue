<template lang="pug">
  .LinearChartMedium(ref="chartdiv")
</template>
...
export default {
  ...
  methods: {
    renderLinearChart() {
      ...
      title1.text = "График прибыли проектов";
      ...
      title2.text = "График роста инвестиций";
      ...
      const values_2 = [250000, 190000, 210000, 180000, 200000, 170000, 200000];
      //Общие значения
      const data = [];
